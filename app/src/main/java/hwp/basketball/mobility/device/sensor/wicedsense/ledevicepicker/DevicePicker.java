...
public class DevicePicker {
     ...
     * @return
     */
    public static Intent createLaunchIntent(String title, Uri dataUri, String[] deviceFilters, String[] serviceUuids, Context context) {
...
//        mlaunchClassName = launchClassName;
     ...
     * @param cb
     */
    public DevicePicker(Context ctx, Callback cb,
...
//        mlaunchClassName = launchClassName;
     ...
     */
    public boolean launch(String title, String[] deviceFilters, String[] serviceUuids, Context context) {
        if (!BluetoothAdapter.getDefaultAdapter().isEnabled()) {
            return false;
        }
        Intent intent = createLaunchIntent(title, mDevicePickerDataUri, deviceFilters, serviceUuids, context);
