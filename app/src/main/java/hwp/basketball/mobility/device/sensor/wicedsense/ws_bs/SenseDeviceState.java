...
import hwp.basketball.mobility.device.sensor.wicedsense.util.GattRequestManager;
import hwp.basketball.mobility.device.sensor.wicedsense.wicedsmart.ota.OtaAppInfo;
import hwp.basketball.mobility.device.sensor.wicedsense.wicedsmart.ota.OtaAppInfoReader;

import static hwp.basketball.mobility.device.sensor.wicedsense.wicedsmart.ota.OtaAppInfoReader.*;
 ...
 *
 */
public class SenseDeviceState extends BluetoothGattCallback implements Handler.Callback,
        GattRequestManager.LePairingCallback, Callback {
