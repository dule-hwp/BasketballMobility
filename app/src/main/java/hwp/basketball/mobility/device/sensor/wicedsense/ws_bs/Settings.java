...
public class Settings {
     ...
     */
    public static final long SERVICE_INIT_TIMEOUT_MS = 250;
    ...
    private static final ArrayList<SettingChangeListener> mChangeListeners = new ArrayList<SettingChangeListener>();
