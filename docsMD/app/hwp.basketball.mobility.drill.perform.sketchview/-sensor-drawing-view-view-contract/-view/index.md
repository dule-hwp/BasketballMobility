[app](../../../index.md) / [hwp.basketball.mobility.drill.perform.sketchview](../../index.md) / [SensorDrawingViewViewContract](../index.md) / [View](.)
...
| [getDesiredPathLength](get-desired-path-length.md) | `abstract fun getDesiredPathLength(): `[`Float`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-float/index.html)<br>get Path length |
...
| Name | Summary |
|---|---|
| [SensorDrawingView](../../-sensor-drawing-view/index.md) | `class SensorDrawingView : `[`View`](https://developer.android.com/reference/android/view/View.html)`, View`<br>Custom view made for the purpose of drawing sensor generated path on top of basketball field bitmap. |
