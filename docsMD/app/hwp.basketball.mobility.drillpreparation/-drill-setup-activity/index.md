...
| [onCompleted](on-completed.md) | `open fun onCompleted(completeButton: `[`View`](https://developer.android.com/reference/android/view/View.html)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)<br>Used to handle BLE scan for devices and |
